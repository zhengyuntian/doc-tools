...
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PAGE_MARGIN', '页边距检查', 'layout', 'PAGE_MARGIN', 'margin_bottom', '下边距', '2.5', 'cm', 'FLOAT', NULL, 4, 1, 'admin', NOW(), 0);
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PAGE_MARGIN', '页边距检查', 'layout', 'PAGE_MARGIN', 'margin_left', '左边距', '2.5', 'cm', 'FLOAT', NULL, 5, 1, 'admin', NOW(), 0);
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PAGE_MARGIN', '页边距检查', 'layout', 'PAGE_MARGIN', 'margin_right', '右边距', '2.5', 'cm', 'FLOAT', NULL, 6, 1, 'admin', NOW(), 0);
...
-- 6. 段落对齐检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PARAGRAPH_ALIGN', '段落对齐检查', 'layout', 'PARAGRAPH_ALIGN', 'alignment', '对齐方式', 'left', '', 'SELECT', '["left:左对齐","right:右对齐","center:居中对齐","justify:两端对齐"]', 10, 1, 'admin', NOW(), 0);

-- 7. 行间距检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('LINE_SPACING', '行间距检查', 'layout', 'LINE_SPACING', 'line_spacing', '行间距', '28', 'pt', 'NUMBER', NULL, 11, 1, 'admin', NOW(), 0);

-- 8. 首行缩进检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('FIRST_LINE_INDENT', '首行缩进检查', 'layout', 'FIRST_LINE_INDENT', 'indent_chars', '缩进字符数', '2', '字符', 'NUMBER', NULL, 12, 1, 'admin', NOW(), 0);

-- 9. 段前段后间距检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PARAGRAPH_SPACE', '段前段后间距检查', 'layout', 'PARAGRAPH_SPACE', 'space_before', '段前间距', '0', 'pt', 'NUMBER', NULL, 13, 1, 'admin', NOW(), 0);
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PARAGRAPH_SPACE', '段前段后间距检查', 'layout', 'PARAGRAPH_SPACE', 'space_after', '段后间距', '0', 'pt', 'NUMBER', NULL, 14, 1, 'admin', NOW(), 0);

-- 10. 特殊格式检查（多选）
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('SPECIAL_FORMAT', '特殊格式检查', 'layout', 'SPECIAL_FORMAT', 'forbidden_styles', '禁止格式', 'bold,underline,italic', '', 'MULTI_SELECT', '["bold:禁止加粗","underline:禁止下划线","italic:禁止斜体"]', 15, 1, 'admin', NOW(), 0);

-- 11. 无底纹检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('BACKGROUND_SHADING', '底纹检查', 'layout', 'BACKGROUND_SHADING', 'no_shading', '无底纹', 'true', '', 'BOOLEAN', NULL, 16, 1, 'admin', NOW(), 0);

-- 12. 段落属性
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PARAGRAPH_PROPERTY', '段落属性', 'layout', 'PARAGRAPH_PROPERTY', 'indent_before', '文本之前缩进', '0', '字符', 'NUMBER', NULL, 17, 1, 'admin', NOW(), 0);
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PARAGRAPH_PROPERTY', '段落属性', 'layout', 'PARAGRAPH_PROPERTY', 'indent_after', '文本之后缩进', '0', '字符', 'NUMBER', NULL, 18, 1, 'admin', NOW(), 0);
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('PARAGRAPH_PROPERTY', '段落属性', 'layout', 'PARAGRAPH_PROPERTY', 'direction', '输入方向', 'left_to_right', '', 'FIXED', '["left_to_right:从左到右"]', 19, 1, 'admin', NOW(), 0);

-- 13. 空格检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('SPACE_CHECK', '空格检查', 'layout', 'SPACE_CHECK', 'check_spaces', '检查空格', 'true', '', 'BOOLEAN', NULL, 20, 1, 'admin', NOW(), 0);
...
-- 14. 文字颜色检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('TEXT_COLOR', '文字颜色检查', 'font', 'TEXT_COLOR', 'font_color', '文字颜色', 'black', '', 'SELECT', '["black:黑色"]', 21, 1, 'admin', NOW(), 0);

-- 15. 是否使用英文标点符号
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('ENGLISH_PUNCTUATION', '英文标点符号检查', 'font', 'ENGLISH_PUNCTUATION', 'use_chinese_punctuation', '使用中文标点', 'true', '', 'BOOLEAN', NULL, 22, 1, 'admin', NOW(), 0);

-- 16. 是否允许字体缩放
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('FONT_SCALING', '字体缩放检查', 'font', 'FONT_SCALING', 'allow_scaling', '允许字体缩放', 'false', '', 'BOOLEAN', NULL, 23, 1, 'admin', NOW(), 0);

-- 17. 正文字体检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('BODY_FONT', '正文字体检查', 'font', 'BODY_FONT', 'font_name', '字体名称', '宋体', '', 'SELECT', '["宋体","仿宋","黑体","楷体","Times New Roman","Arial"]', 24, 1, 'admin', NOW(), 0);

-- 18. 正文字号检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('BODY_FONT_SIZE', '正文字号检查', 'font', 'BODY_FONT_SIZE', 'font_size', '字号', '14', 'pt', 'SELECT', '["10.5:10.5号（五号）","12:12号（小四号）","14:14号（四号）","15:15号（小三号）","16:16号（三号）"]', 25, 1, 'admin', NOW(), 0);

-- 19. 字符间距检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('CHARACTER_SPACING', '字符间距检查', 'font', 'CHARACTER_SPACING', 'char_spacing', '字符间距', '0', 'pt', 'FLOAT', NULL, 26, 1, 'admin', NOW(), 0);
...
-- 25. 正文标题字体检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('TITLE_FONT', '正文标题字体检查', 'title', 'TITLE_FONT', 'title_font_name', '标题字体', '黑体', '', 'SELECT', '["宋体","仿宋","黑体","楷体","Times New Roman","Arial"]', 41, 1, 'admin', NOW(), 0);

-- 26. 正文标题字号检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('TITLE_FONT_SIZE', '正文标题字号检查', 'title', 'TITLE_FONT_SIZE', 'title_font_size', '标题字号', '16', 'pt', 'SELECT', '["10.5:10.5号（五号）","12:12号（小四号）","14:14号（四号）","15:15号（小三号）","16:16号（三号）"]', 42, 1, 'admin', NOW(), 0);

-- 27. 正文标题样式检查
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
('TITLE_STYLE', '正文标题样式检查', 'title', 'TITLE_STYLE', 'title_bold', '标题加粗', 'true', '', 'BOOLEAN', NULL, 43, 1, 'admin', NOW(), 0);
INSERT INTO t_dark_rule_config (rule_code, rule_name, rule_category, rule_group, param_key, param_name, param_value, param_unit, param_type, param_options, sort_order, enabled, creator_name, create_time, del_flag) VALUES
